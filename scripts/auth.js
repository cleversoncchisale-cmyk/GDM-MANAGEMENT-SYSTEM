...
(function () {
  ...
  appState.signInWithGoogle = async function () {
    ...
    try {
       ...
       * The authenticated session is restored
  ...
  appState.sendPasswordReset = async function (
    email
  ) {
    ...
    try {
      ...
      /*
       * Return the user to the current site
  ...
  appState.handleSupabaseUser = async function (
    user
  ) {
    ...
    if (!user) {
       ...
       * Return them to the main login page.
       */
